...
namespace BTrainController.Views
{
    ...
    public sealed class SpeedMeterView : Control
    {
        #region Constants
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(double), typeof(SpeedMeterView), new PropertyMetadata(0.0));

        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(double), typeof(SpeedMeterView), new PropertyMetadata(100.0));

        public static readonly DependencyProperty ScaleWidthProperty =
            DependencyProperty.Register("ScaleWidth", typeof(Double), typeof(SpeedMeterView), new PropertyMetadata(26.0));

        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(double), typeof(SpeedMeterView), new PropertyMetadata(0.0, OnValueChanged));

        public static readonly DependencyProperty UnitProperty =
            DependencyProperty.Register("Unit", typeof(string), typeof(SpeedMeterView), new PropertyMetadata(string.Empty));

        public static readonly DependencyProperty ScaleBrushProperty =
            DependencyProperty.Register("ScaleBrush", typeof(Brush), typeof(SpeedMeterView), new PropertyMetadata(new SolidColorBrush(Colors.DarkGray)));

        public static readonly DependencyProperty TrailBrushProperty =
            DependencyProperty.Register("TrailBrush", typeof(Brush), typeof(SpeedMeterView), new PropertyMetadata(new SolidColorBrush(Colors.Orange)));

        public static readonly DependencyProperty UnitBrushProperty =
            DependencyProperty.Register("UnitBrush", typeof(Brush), typeof(SpeedMeterView), new PropertyMetadata(new SolidColorBrush(Colors.White)));

        public static readonly DependencyProperty ValueAngleProperty =
            DependencyProperty.Register("ValueAngle", typeof(double), typeof(SpeedMeterView), new PropertyMetadata(null));

        public static readonly DependencyProperty SpeedLevelProperty =
            DependencyProperty.Register(nameof(SpeedLevel), typeof(ESpeedLevel), typeof(SpeedMeterView), new PropertyMetadata(ESpeedLevel.Stop, OnSpeedLevelChanged));
        ...
        public SpeedMeterView()
        {
            this.DefaultStyleKey = typeof(SpeedMeterView);
        ...
        {
            var ctrl = obj as SpeedMeterView;
